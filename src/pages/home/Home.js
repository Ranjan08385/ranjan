...
const resume = require("../../resume/Ranjan_Resume.pdf");
  ...
  return (
    ...
    >
      <div className="home__left">
        <motion.p variants={leftText}>
          Hi, <br />
          i'am <motion.span variants={leftText}>Ranjan</motion.span> <br />
          Web Developer
        </motion.p>
        <a href={resume} target="_blank">
          <motion.button variants={resumeButton}>Resume</motion.button>
        </a>
      ...
      <div data-aos="zoom-in" variants={homeImg} className="home__right">
