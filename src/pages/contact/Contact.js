...
function Contact() {
  ...
  const _handleChangeEmail = useCallback(
    (event) => {
  ...
  const _handleChangeTextArea = useCallback(
    (event) => setTextArea(event.target.value),
    [setTextArea]
  );
      ...
      <form onSubmit={(e) => onClickSend(e)}>
        <div className="contact__form">
          <div
            data-aos="fade-right"
            data-aos-delay="100"
            variants={contactName}
            className="contact__nameSec"
          >
            <input
              className="contact__nameField"
              type="text"
              placeholder="Name"
              name="name"
              value={name}
          ...
          <div
            data-aos="fade-right"
            data-aos-delay="300"
            variants={contactEmail}
            className="contact__emailSec"
          >
            <input
              className="contact__emailField"
              type="text"
              placeholder="Email"
              name="email"
              value={email}
          ...
          <div
            data-aos="fade-right"
            data-aos-delay="600"
            variants={contactTextArea}
            className="contact__textAreaSec"
            value={textArea}
            onChange={_handleChangeTextArea}
          >
          ...
          <p className="contact__msg">{msg}</p>
        </div>
      </form>
    </motion.div>
  );
